!(function (e, t) {
  ...
  function ht(e) {
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          t = (i = at(e[r]).split('-')).length, n = (n = at(e[r + 1])) ? n.split('-') : null;
          0 < t;
  ...
  (mn.add = Jt),
    ...
    (mn.hasAlignedHourOffset = function (e) {
      return (
        !!this.isValid() && ((e = e ? bt(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
      );
    }),
    (mn.isDST = function () {
      return (
  ...
  (yn.calendar = function (e, t, n) {
    ...
    ut('en', {
      ...
      ordinal: function (e) {
        ...
        return (
          e +
          (1 === D((e % 100) / 10) ? 'th' : 1 === t ? 'st' : 2 === t ? 'nd' : 3 === t ? 'rd' : 'th')
        );
      },
    }),
  ...
  return (
    ...
    (c.relativeTimeThreshold = function (e, t) {
      return (
        void 0 !== jn[e] && (void 0 === t ? jn[e] : ((jn[e] = t), 's' === e && (jn.ss = t - 1), !0))
      );
    }),
