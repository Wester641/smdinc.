      ...
      0 === o.length &&
        ...
        e.each(function () {
          ...
          a.stickySidebar.css('padding-top', 1),
            ...
            0 == r
              ? (a.stickySidebar.css('padding-top', 0), (a.stickySidebarPaddingTop = 0))
              ...
              if (a.stickySidebar.is(':visible')) {
                ...
                if (r >= a.sidebar.offset().top + (a.paddingTop - a.options.additionalMarginTop)) {
                  ...
                  d =
                    (k || y != h) && (k || y != c - a.stickySidebar.outerHeight())
                      ? r + y - a.sidebar.offset().top - a.paddingTop <= t.additionalMarginTop
                        ? 'static'
                        : 'absolute'
                      : 'fixed';
                }
                if ('fixed' == d) {
                  ...
                  a.stickySidebar.css({
                    ...
                    left:
                      a.sidebar.offset().left + parseInt(a.sidebar.css('padding-left')) - v + 'px',
                    top: '0px',
                  });
                } else if ('absolute' == d) {
                  var x = {};
