  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function k(t, n) {
        ...
        for (
          r = 0;
          r < e.unitsDesc.length && ((i = e.unitsDesc[r]), !((o = V(i, t, n)) >= 1 && ut(o)));
          r++
        );
        return i;
      }
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.intersectsWith = function (t) {
              return (
                (null == this.endMs || null == t.startMs || this.endMs > t.startMs) &&
                (null == this.startMs || null == t.endMs || this.startMs < t.endMs)
              );
            }),
            (t.prototype.containsRange = function (t) {
              return (
                (null == this.startMs || (null != t.startMs && t.startMs >= this.startMs)) &&
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.prototype.getListenerNamespace = function () {
              return (
                null == this.listenerId && (this.listenerId = s++), '_listener' + this.listenerId
              );
            }),
            e
          );
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.prototype.applyManualStandardProps = function (e) {
              ...
              return (
                !!r && ((this.dateProfile = r), null != e.date && (this.miscProps.date = e.date), n)
              );
            }),
            e
          );
            ...
            (t.parse = function (e, n) {
              ...
              return (
                ...
                !0 === l
                  ...
                  : !1 === l && (s.hasTime() || s.time(0), a && !a.hasTime() && a.time(0)),
          ...
          return (
                ...
                e
                  ? ((r = { left: s.getEvX(e), top: s.getEvY(e) }),
                    ...
                    o &&
                      ...
                      (this.origHit && (n = s.intersectRects(this.origHit, n) || n),
                      (i = s.getRectCenter(n))),
            ...
            (e.prototype.handleDrag = function (e, n, i) {
              ...
              t.prototype.handleDrag.call(this, e, n, i),
                ...
                r(o, this.hit) || (this.hit && this.handleHitOut(), o && this.handleHitOver(o));
            }),
            ...
            (e.prototype.handleHitOut = function () {
              this.hit &&
                (this.trigger('hitOut', this.hit), this.handleHitDone(), (this.hit = null));
            }),
            ...
            (e.prototype.queryHit = function (t, e) {
              return (
                this.coordAdjust && ((t += this.coordAdjust.left), (e += this.coordAdjust.top)),
          ...
          return (
            ...
            (t.prototype.unbind = function () {
              this.stopListeningTo(r(document)),
                window.removeEventListener('touchmove', this.handleTouchMoveProxy, { passive: !1 }),
    ...
    function (t, e, n) {
      ...
      function i(t, n, r) {
        ...
        var o = a.datepicker;
        o &&
          ((o.regional[n] = o.regional[t] = r), (o.regional.en = o.regional['']), o.setDefaults(r));
      }
      function o(t, n) {
        var r, i;
            ...
            (t.prototype.mutateSingle = function (t) {
              ...
              return (
                ...
                this.verbatimStandardProps &&
                  a.default.copyVerbatimStandardProps(this.verbatimStandardProps, t),
          ...
          return (
            (t.createFromDiff = function (e, n, i) {
              ...
              return (
                (s = o(n.start, e.start)),
                n.end &&
                  ((a = o(n.unzonedRange.getEnd(), e.unzonedRange.getEnd())), (l = a.subtract(s))),
                (u = new t()),
                (u.clearEnd = d),
                (u.forceTimed = c),
                (u.forceAllDay = p),
            ...
            (t.prototype.buildNewDateProfile = function (t, e) {
              ...
              return (
                t.end && !this.clearEnd
                  ? (r = t.end.clone())
                  : this.endDelta && !r && (r = e.getDefaultEventEnd(t.isAllDay(), n)),
                this.forceTimed
                  ? ((o = !0), n.hasTime() || n.time(0), r && !r.hasTime() && r.time(0))
                  : this.forceAllDay &&
                    (n.hasTime() && n.stripTime(), r && r.hasTime() && r.stripTime()),
          ...
          return (
            ...
            (e.prototype.updateNowIndicator = function () {
              this.isDatesRendered &&
                ...
                this.renderNowIndicator(
                  this.initialNowDate.clone().add(new Date().valueOf() - this.initialNowQueriedMs),
                ),
            ...
            (e.prototype.stopNowIndicator = function () {
              this.isNowIndicatorRendered &&
                (this.nowIndicatorTimeoutID &&
                  (clearTimeout(this.nowIndicatorTimeoutID), (this.nowIndicatorTimeoutID = null)),
            ...
            (e.prototype.processRangeUnselect = function (t) {
              ...
              this.isSelected &&
                ...
                (((e = this.opt('unselectCancel')) && i(t.target).closest(e).length) ||
                  this.unselect(t));
            }),
            (e.prototype.processEventUnselect = function (t) {
              this.selectedEventInstance &&
                (i(t.target).closest('.fc-selected').length || this.unselectEventInstance());
            }),
            ...
            (e.prototype.initHiddenDays = function () {
              var t,
                ...
                n = [],
                r = 0;
              for (!1 === this.opt('weekends') && e.push(0, 6), t = 0; t < 7; t++)
    ...
    function (t, e, n) {
      ...
      function s(t, e, n, r, i) {
        ...
        for (
          s = l.length - 1;
          s > o && (!l[s] || u.isSame(d, l[s])) && (s - 1 !== o || '.' !== c[s]);
          s--
        )
          v = c[s] + v;
      ...
      function f(t, e) {
        ...
        for (n = 0; n < s.length; n++)
          (r = s[n]), r.charAt(0) === b ? i.push(E[r.substring(1)](e)) : i.push(r);
        return i;
      }
      function g(t) {
      ...
      function v(t) {
        ...
        for (e = 0; e < o.length; e++)
          (n = o[e]), n.token && (r = S[n.token.charAt(0)]) && (!i || r.value > i.value) && (i = r);
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.prototype.set = function (t, e) {
              var n;
              'string' == typeof t ? ((n = {}), (n[t] = void 0 === e ? null : e)) : (n = t),
                this.setProps(n);
            }),
            ...
            (e.prototype.setProps = function (t) {
              var e,
                ...
                i = 0;
              for (e in t)
                ('object' != typeof (n = t[e]) && n === this._props[e]) || ((r[e] = n), i++);
              if (i) {
        ...
        u = (function (t) {
          ...
          return (
            ...
            (e.prototype.buildInstances = function (t) {
              for (
                var e, n, r, i = this.source.calendar, o = t.getStart(), s = t.getEnd(), u = [];
                o.isBefore(s);
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.buildValidRange = function () {
              return (
                this._view.getUnzonedRangeOption('validRange', this._view.calendar.getNow()) ||
                new o.default()
              );
            }),
            ...
            (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
              ...
              return (
                h ||
                  ...
                  l
                    ? ((u = r.duration(l)), (h = u < n ? i.computeDurationGreatestUnit(u, l) : s))
                    : (h = s)),
                n.as('days') <= 1 &&
        ...
        u = (function (t) {
          ...
          return (
            ...
            (e.parse = function (t, e) {
              var n;
              return (
                i.isArray(t.events) ? (n = t) : i.isArray(t) && (n = { events: t }),
          ...
          return (
            ...
            (t.prototype.queryBoundingRect = function () {
              ...
              return this.els.length > 0 &&
                ((t = i.getScrollParent(this.els.eq(0))), !t.is(document) && !t.is('html,body'))
                ? i.getClientRect(t)
                : null;
            }),
            ...
            (t.prototype.isLeftInBounds = function (t) {
              return (
                !this.boundingRect || (t >= this.boundingRect.left && t < this.boundingRect.right)
              );
            }),
            (t.prototype.isTopInBounds = function (t) {
              return (
                !this.boundingRect || (t >= this.boundingRect.top && t < this.boundingRect.bottom)
              );
            }),
            t
          );
          ...
          return (
            ...
            (t.prototype.initAutoScroll = function () {
              ...
              (this.isAutoScroll = this.options.scroll && t && !t.is(window) && !t.is(document)),
                this.isAutoScroll &&
                  this.listenTo(t, 'scroll', i.debounce(this.handleDebouncedScroll, 100));
            }),
            ...
            (e.prototype.updateDayTable = function () {
              for (
                var t,
                  ...
                  i = r.view,
                  o = i.calendar,
                  s = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.startMs, !0),
                  a = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.endMs, !0),
                  l = -1,
                  u = [],
                  d = [];
                s.isBefore(a);
                ...
                i.isHiddenDay(s) ? u.push(l + 0.5) : (l++, u.push(l), d.push(s.clone())),
                  s.add(1, 'days');
              ...
              if (e.length) {
                ...
                r(s).each(function (t, i) {
                  ...
                  n.filterEl && (l = n.filterEl(s, l)),
                    l && ((l = r(l)), l.is(o.fillSegTag) && ((s.el = l), a.push(s)));
                });
              }
              return a;
            }),
          ...
          return (
            ...
            (t.prototype.renderEventFootprints = function (t, e, n, r) {
              var i,
                ...
                s = 'fc-helper ' + (n || '');
              for (o = this.eventRenderer.renderFgSegEls(o), i = 0; i < o.length; i++)
                o[i].el.addClass(s);
          ...
          return (
            ...
            (e.prototype.renderGrid = function () {
              var t,
                ...
                o = '';
              for (
                this.headContainerEl && this.headContainerEl.html(this.renderHeadHtml()), t = 0;
                t < r;
                t++
              )
            ...
            (e.prototype.renderNumberCellsHtml = function (t) {
              var e,
                ...
                r = [];
              for (e = 0; e < this.colCnt; e++)
                (n = this.getCellDate(t, e)), r.push(this.renderNumberCellHtml(n));
              return r.join('');
            }),
              ...
              return s || this.cellWeekNumbersVisible
                ? ((e = this.getDayClasses(t)),
                  ...
                  this.cellWeekNumbersVisible &&
                    (n =
                      'ISO' === t._locale._fullCalendar_weekCalc ? 1 : t._locale.firstDayOfWeek()),
                  (i +=
                    '<td class="' +
                    e.join(' ') +
                    '"' +
            ...
            (e.prototype.limitRows = function (t) {
              ...
              for (e = 0; e < r.length; e++)
                this.unlimitRow(e),
                  !1 !== (n = !!t && ('number' == typeof t ? t : this.computeRowLevelLimit(e))) &&
                    this.limitRow(e, n);
            }),
            ...
            (e.prototype.limitRow = function (t, e) {
              ...
              if (e && e < b.segLevels.length) {
                for (
                  ...
                  if (u) {
                    for (
                      c = r[e - 1][a.leftCol], p = c.attr('rowspan') || 1, h = [], f = 0;
                      f < d.length;
                      f++
                    )
                ...
                .on('click', function (s) {
                  ...
                  'function' == typeof a &&
                    (a = r.publiclyTrigger('eventLimitClick', {
                      context: o,
                      args: [
                        { date: l.clone(), dayEl: d, moreEl: u, segs: p, hiddenSegs: h },
                        s,
                        o,
                      ],
                    })),
            ...
            (e.prototype.renderSegPopoverContent = function (t, e, n) {
              ...
              for (
                n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, r = 0;
                r < n.length;
                r++
              )
                this.hitsNeeded(),
                    ...
                    p.push(
                      i.extend({}, r, {
                        footprint: new d.default(
                          new u.default(o, r.footprint.componentFootprint.isAllDay),
            ...
            (e.prototype.getCellSegs = function (t, e, n) {
              for (
                var r, i = this.eventRenderer.rowStructs[t].segMatrix, o = n || 0, s = [];
                o < i.length;
      ...
      function r(t) {
        return (function (t) {
          ...
          return (
            ...
            (e.prototype.getIsNumbersVisible = function () {
              return (
                d.default.prototype.getIsNumbersVisible.apply(this, arguments) ||
          ...
          return (
            ...
            (e.prototype.updateSize = function (e, n, r) {
              ...
              if (!this.dayGrid.rowEls)
                return void (
                  n || ((i = this.computeScrollerHeight(e)), this.scroller.setHeight(i))
                );
              t.prototype.updateSize.call(this, e, n, r),
                this.dayGrid.colWeekNumbersVisible &&
                  (this.weekNumberWidth = s.matchCellWidths(this.el.find('.fc-week-number'))),
                this.scroller.clear(),
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.buildRenderRange = function (e, n, r) {
              ...
              return (
                /^(year|month)$/.test(n) &&
                  (s.startOf('week'), a.weekday() && a.add(1, 'week').startOf('week')),
                new i.default(s, a)
              );
            }),
            e
          ...
          return (
            ...
            (t.prototype.isEventInstanceGroupAllowed = function (t) {
              ...
              if (d)
                for (e = 0; e < r.length; e++)
                  if (
                    !1 ===
                    d(r[e].componentFootprint.toLegacy(this._calendar), r[e].getEventLegacy())
                  )
                    return !1;
              return !0;
            }),
            ...
            (t.prototype.isSelectionFootprintAllowed = function (t) {
              ...
              return (
                ...
                (!(e = this.opt('selectAllow')) || !1 !== e(t.toLegacy(this._calendar)))
              );
            }),
        ...
        u = (function () {
          ...
          return (
            ...
            (t.prototype.addEventDef = function (t) {
              ...
              for (i.push(t), this.eventDefsByUid[t.uid] = t, e = 0; e < o.length; e++)
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.parse = function (t, e) {
              var n;
              return (
                i.isFunction(t.events) ? (n = t) : i.isFunction(t) && (n = { events: t }),
    ...
    function (t, e, n) {
        ...
        l = (function (t) {
          ...
          return (
            ...
            (e.parse = function (t, e) {
              var n;
              return (
                'string' == typeof t.url ? (n = t) : 'string' == typeof t && (n = { url: t }),
                !!n && a.default.parse.call(this, n, e)
              );
            }),
      ...
      (e.default = l),
        l.defineStandardProps({ url: !0, startParam: !0, endParam: !0, timezoneParam: !0 });
    },
    function (t, e) {
      Object.defineProperty(e, '__esModule', { value: !0 });
      var n = (function () {
          ...
          return (
            ...
            (e.prototype.queue = function (t, e, n) {
              ...
              e && (r = this.waitsByNamespace[e]),
                ...
                this.compoundTask(i) &&
                  (this.waitNamespace || null == r ? this.tryStart() : this.startWait(e, r));
            }),
            ...
            (e.prototype.clearWait = function () {
              this.waitNamespace &&
                (clearTimeout(this.waitId), (this.waitId = null), (this.waitNamespace = null));
            }),
          ...
          function e(n, r) {
            ...
            return (
              ...
              i.helperRendererClass &&
                i.eventRenderer &&
                (i.helperRenderer = new i.helperRendererClass(i, i.eventRenderer)),
              i.businessHourRendererClass &&
                i.fillRenderer &&
                (i.businessHourRenderer = new i.businessHourRendererClass(i, i.fillRenderer)),
              i
            );
          }
          return (
              ...
              this.hasPublicHandlers('eventAfterRender') &&
                t.forEach(function (t) {
                  ...
                  t.el &&
                    ...
                    e.publiclyTrigger('eventAfterRender', { context: n, args: [n, t.el, e] }));
                });
            }),
            ...
            (e.prototype.triggerBeforeEventSegsDestroyed = function (t) {
              ...
              this.hasPublicHandlers('eventDestroy') &&
                t.forEach(function (t) {
                  ...
                  t.el &&
                    ((n = t.footprint.getEventLegacy()),
                    e.publiclyTrigger('eventDestroy', { context: n, args: [n, t.el, e] }));
                });
            }),
            ...
            (e.prototype.buildGotoAnchorHtml = function (t, e, n) {
              ...
              return (
                ...
                (n = n || ''),
                !s && this.opt('navLinks')
                  ? '<a' + e + ' data-goto="' + a.htmlEscape(JSON.stringify(u)) + '">' + n + '</a>'
                  : '<span' + e + '>' + n + '</span>'
              );
            }),
              ...
              return (
                this.dateProfile.activeUnzonedRange.containsDate(t)
                  ? (i.push('fc-' + a.dayIDs[t.day()]),
                    ...
                    (n = r.calendar.getNow()),
                    t.isSame(n, 'day')
                      ? (i.push('fc-today'), !0 !== e && i.push(r.calendar.theme.getClass('today')))
                      : t < n
                        ? i.push('fc-past')
                        : i.push('fc-future'))
          ...
          return (
            ...
            (t.prototype.publiclyTrigger = function (t, e) {
              var n,
                ...
                o = this.opt(t);
              if (
                (i.isPlainObject(e) ? ((n = e.context), (r = e.args)) : i.isArray(e) && (r = e),
                null == n && (n = this.el[0]),
                r || (r = []),
            ...
            (t.prototype.zoomTo = function (t, e) {
              ...
              (e = e || 'day'),
                (n =
                  this.viewSpecManager.getViewSpec(e) || this.viewSpecManager.getUnitViewSpec(e)),
            ...
            (t.prototype.render = function () {
              this.contentEl
                ? this.elementVisible() && (this.calcSize(), this.updateViewSize())
                : this.initialRender();
            }),
            ...
            (t.prototype.bindViewHandlers = function (t) {
              ...
              t.watch('titleForCalendar', ['title'], function (n) {
                ...
                t.watch('dateProfileForCalendar', ['dateProfile'], function (n) {
                  t === e.view &&
                    ((e.currentDate = n.dateProfile.date), e.updateToolbarButtons(n.dateProfile));
                });
            }),
            ...
            (t.prototype.renderView = function (t) {
              ...
              this.freezeContentHeight(),
                ...
                !this.view &&
                  t &&
                  ((e = this.view =
                    this.viewsByType[t] || (this.viewsByType[t] = this.instantiateView(t))),
                  this.bindViewHandlers(e),
                  e.startBatchRender(),
                  e.setElement(
                    i("<div class='fc-view fc-" + t + "-view'>").appendTo(this.contentEl),
                  ),
                  this.toolbarsManager.proxyCall('activateButton', t)),
                this.view &&
                  (this.view.get('businessHourGenerator') !== this.businessHourGenerator &&
                ...
                this.optionsManager.watch(
                  ...
                  function (e) {
                    ...
                    e.monthNames && (o._months = e.monthNames),
                      ...
                      ('ISO' !== r && 'local' !== r && 'function' != typeof r) ||
            ...
            (t.prototype.footprintToDateProfile = function (t, e) {
              ...
              return (
                ...
                t.isAllDay
                  ...
                  : ((r = this.applyTimezone(r)), n && (n = this.applyTimezone(n))),
          ...
          return (
            ...
            (e.prototype.handleMouseDown = function (t, e) {
              this.component.canStartResize(t, e) &&
                this.buildDragListener(t, i(e.target).is('.fc-start-resizer')).startInteraction(e, {
                  distance: 5,
                });
            }),
                ...
                hitOver: function (n, l, c) {
                  ...
                  g && v
                    ...
                    r &&
                      ...
                      a.renderEventResize(
                        s.eventRangesToEventFootprints(
                          h.sliceRenderRanges(s.dateProfile.renderUnzonedRange, u),
                        ),
                        t,
                      ));
                },
          ...
          return (
            ...
            (e.prototype.handleTouchStart = function (t, e) {
              ...
              n.canStartDrag(t, e)
                ...
                : n.canStartSelection(t, e) && this.buildSelectListener(t).startInteraction(e, r);
            }),
          ...
          return (
            ...
            (e.prototype.bindToEl = function (t) {
              ...
              n.bindDateHandlerToEl(t, 'mousedown', function (t) {
                e.opt('selectable') &&
                  !n.shouldIgnoreMouse() &&
                  r.startInteraction(t, { distance: e.opt('selectMinDistance') });
              }),
            ...
            (e.prototype.isSelectionFootprintAllowed = function (t) {
              return (
                this.component.dateProfile.validUnzonedRange.containsRange(t.unzonedRange) &&
          ...
          return (
            ...
            (e.prototype.updateSize = function (e, n, r) {
              ...
              if (
                ...
                return void (
                  n || ((o = this.computeScrollerHeight(e)), this.scroller.setHeight(o))
                );
          ...
          return (
              ...
              for (
                ...
                (t = i.msToUtcMoment(u.renderUnzonedRange.startMs).time(c)),
                  ...
                  (n =
                    ...
                    r.axisStyleAttr() +
                    '>' +
                    (e ? '<span>' + s.htmlEscape(t.format(this.labelFormat)) + '</span>' : '') +
                    '</td>'),
                  (d +=
                    '<tr data-time="' +
                    t.format('HH:mm:ss') +
            ...
            (e.prototype.renderContentSkeleton = function () {
              ...
              (e = this.contentSkeletonEl =
                i('<div class="fc-content-skeleton"><table><tr>' + n + '</tr></table></div>')),
            ...
            (e.prototype.renderNowIndicator = function (t) {
              if (this.colContainerEls) {
                ...
                for (e = 0; e < n.length; e++)
                  o.push(
                    i('<div class="fc-now-indicator fc-now-indicator-line"></div>')
                      .css('top', r)
                      .appendTo(this.colContainerEls.eq(n[e].col))[0],
                  );
                n.length > 0 &&
                  o.push(
                    i('<div class="fc-now-indicator fc-now-indicator-arrow"></div>')
                      .css('top', r)
        ...
        c = (function (t) {
          ...
          return (
            ...
            (e.prototype.renderFgSegsIntoContainers = function (t, e) {
              var n, r;
              for (n = this.timeGrid.groupSegsByCol(t), r = 0; r < this.timeGrid.colCnt; r++)
            ...
            (e.prototype.fgSegHtml = function (t, e) {
              ...
              if (
                (f.unshift('fc-time-grid-event', 'fc-v-event'), o.isMultiDayRange(a.unzonedRange))
              ) {
            ...
            (e.prototype.fgSegHtml = function (t, e) {
              ...
              return (
                ...
                '<a class="' +
                  ...
                  (d ? '<div class="fc-resizer fc-end-resizer"></div>' : '') +
                  '</a>'
              );
            }),
            e
          ...
          return (
            ...
            (e.prototype.renderFillRow = function (t, e) {
              ...
              return (
                ...
                (r = i('<div class="fc-' + n + '-skeleton"><table><tr></tr></table></div>')),
                (o = r.find('tr')),
                a > 0 && o.append(new Array(a + 1).join('<td></td>')),
                o.append(e.el.attr('colspan', l - a)),
                l < s && o.append(new Array(s - l + 1).join('<td></td>')),
            ...
            (e.prototype.buildRenderRange = function (e, n, r) {
              ...
              return (
                this.opt('fixedWeekCount') &&
                  ((i = Math.ceil(l.diff(a, 'weeks', !0))), l.add(6 - i, 'weeks')),
                new o.default(a, l)
              );
            }),
            e
        ...
        c = (function (t) {
          function e(e, n) {
            ...
            return (
              ...
              (r.scroller = new l.default({ overflowX: 'hidden', overflowY: 'auto' })),
              r
            );
          }
          return (
              ...
              for (e = 0; e < i.length; e++)
                if (
                  ...
                  !r.isEnd &&
                    !t.isAllDay &&
                    e + 1 < i.length &&
                    t.unzonedRange.endMs < i[e + 1].startMs + this.nextDayThreshold)
                ) {
            ...
            (t.prototype.render = function () {
              ...
              t
                ? (e
                    ? e.empty()
                    : (e = this.el =
                        r("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'>")),
                  e
                          ...
                          g &&
                            ...
                            (w = r(
                              ...
                              .hover(
                                ...
                                function () {
                                  w.removeClass(o.getClass('stateHover')).removeClass(
                                    o.getClass('stateDown'),
                                  );
                                },
                              )),
                            (h = h.add(w))));
          ...
          return (
                ...
                !!e.class &&
                  ...
                  i &&
                    ...
                    l.valueOf() &&
                      ...
                      (e.duration = l),
                      (e.durationUnit = u),
                      1 === l.as(u) && ((e.singleUnit = u), h.unshift(d[u] || {})))),
            ...
            (t.prototype.buildViewSpecButtonText = function (t, e) {
              ...
              (t.buttonTextOverride =
                n(r.dynamicOverrides) || n(r.overrides) || t.overrides.buttonText),
                (t.buttonTextDefault =
                  n(r.localeDefaults) ||
                  n(r.dirDefaults) ||
                  t.defaults.buttonText ||
                  n(a.globalDefaults) ||
                  (t.duration ? this._calendar.humanizeDuration(t.duration) : null) ||
                  e);
            }),
            t
          );
