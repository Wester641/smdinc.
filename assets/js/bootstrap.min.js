                ...
                return function i(o) {
                  for (
                    ...
                    for (var a = s.length; a--; )
                      if (s[a] === r)
                        return (
                          (o.delegateTarget = r), i.oneOff && Q.off(t, o.type, n), n.apply(r, [o])
                        );
                  return null;
                };
              })(t, n, i)
      ...
      return (
        ...
        (n._setActiveIndicatorElement = function (t) {
          if (this._indicatorsElement) {
            for (var e = V.find('.active', this._indicatorsElement), n = 0; n < e.length; n++)
    ...
    mt = (function (e) {
      ...
      return (
        ...
        (a._getConfig = function (t) {
          return (
            (t = s({}, this.constructor.Default, q.getDataAttributes(this._element), t)),
    ...
    bt = (function (t) {
      ...
      return (
        ...
        (n._adjustDialog = function () {
          ...
          ((!this._isBodyOverflowing && t && !T) || (this._isBodyOverflowing && !t && T)) &&
        ...
        a = function (t, n) {
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (e.includes(n))
                return !yt.has(n) || Boolean(t.nodeValue.match(wt) || t.nodeValue.match(Et));
              for (
        ...
        (e.jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (n || ((n = new e(this, i)), A(this, 'bs.popover', n)), 'string' == typeof t)
            ) {
  ...
  var Rt = 'scrollspy',
    ...
    Ut = (function (t) {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          if (
            'string' != typeof (t = s({}, Kt, 'object' == typeof t && t ? t : {})).target &&
            g(t.target)
          ) {
            var e = t.target.id;
        ...
        (n._activate = function (t) {
          ...
          n.classList.contains('dropdown-item')
            ? (V.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add('active'),
      ...
      (n.show = function () {
        ...
        if (
          ...
          if (
            ...
            !(
              Q.trigger(this._element, 'show.bs.tab', { relatedTarget: e }).defaultPrevented ||
  ...
  var Ft = { animation: 'boolean', autohide: 'boolean', delay: 'number' },
    ...
    zt = (function (t) {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          return (
            (t = s({}, Yt, q.getDataAttributes(this._element), 'object' == typeof t && t ? t : {})),
