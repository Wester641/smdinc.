    ...
    (i.fn.particle.prototype.draw = function () {
      ...
      switch (((i.canvas.ctx.fillStyle = n), i.canvas.ctx.beginPath(), e.shape)) {
        ...
        case 'image2':
          ...
          ((c = document.createElement('img')).src = i.particles.shape.image2.src),
            (c.width = i.particles.shape.image2.width),
            (c.height = i.particles.shape.image2.height),
            (r = c) && a();
          break;
        case 'image3':
          if ('svg' == i.tmp.img_type) r = e.img.obj;
          else r = i.tmp.img_obj;
          ((c = document.createElement('img')).src = i.particles.shape.image3.src),
            (c.width = i.particles.shape.image3.width),
            (c.height = i.particles.shape.image3.height),
            (r = c) && a();
          break;
        case 'image4':
          ...
          var c;
          ((c = document.createElement('img')).src = i.particles.shape.image4.src),
            (c.width = i.particles.shape.image4.width),
            (c.height = i.particles.shape.image4.height),
            (r = c) && a();
      }
          ...
          if (s >= 0 && 'mousemove' == i.interactivity.status) {
            ...
            if (i.interactivity.modes.bubble.opacity != i.particles.opacity.value)
              if (i.interactivity.modes.bubble.opacity > i.particles.opacity.value)
                ...
                (o =
                  e.opacity -
                  (i.particles.opacity.value - i.interactivity.modes.bubble.opacity) * s) <
                  e.opacity &&
                  o >= i.interactivity.modes.bubble.opacity &&
                  (e.opacity_bubble = o);
          }
        ...
        function p(a, t, s, n, r) {
          if (a != t)
            if (i.tmp.bubble_duration_end)
              null != s &&
                ((o = a + (a - (n - (v * (n - a)) / i.interactivity.modes.bubble.duration))),
