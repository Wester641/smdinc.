  ...
  !(function (z) {
    ...
    (i = null),
      String.prototype.startsWith ||
        ...
        (c = {}.toString),
        t
          ? t(String.prototype, 'startsWith', { value: h, configurable: !0, writable: !0 })
      ...
      K = {
        ...
        text: function (e, t) {
          ...
          if (e.content) n.innerHTML = e.content;
            ...
            e.subtext &&
              (((i = _.subtext.cloneNode(!1)).textContent = e.subtext), n.appendChild(i));
          }
        ...
        label: function (e) {
          ...
          return (
            e.subtext &&
              (((t = _.subtext.cloneNode(!1)).textContent = e.subtext), s.appendChild(t)),
            _.fragment.appendChild(s),
            _.fragment
          );
        },
        ...
        createView: function (A, e, t) {
          ...
          function l(e, t) {
            ...
            for (var f = 0; f < s; f++) {
              ...
              void 0 === r &&
                e - 1 <= D.selectpicker.current.data[m - 1].position - D.sizeInfo.menuInnerHeight &&
                (r = f);
            }
            if (
              (void 0 === r && (r = 0),
              ...
              (a =
                l[0] !== D.selectpicker.view.position0 || l[1] !== D.selectpicker.view.position1),
              void 0 !== D.activeIndex &&
                ...
                t &&
                  (D.activeIndex !== D.selectedIndex && D.defocusItem(H), (D.activeIndex = void 0)),
              ...
              for (var y = x.length; f < y; f++) {
                ...
                D.options.sanitize &&
                  ($ = E.lastChild) &&
                  (S = D.selectpicker.current.data[f + D.selectpicker.view.position0]) &&
                  S.content &&
                  !S.sanitized &&
                ...
                !0 === u
                  ? ((v =
                      0 === D.selectpicker.view.position0
                        ? 0
                        : D.selectpicker.current.data[D.selectpicker.view.position0 - 1].position),
                    (g =
                      D.selectpicker.view.position1 > d - 1
                        ? 0
                        : D.selectpicker.current.data[d - 1].position -
                          D.selectpicker.current.data[D.selectpicker.view.position1 - 1].position),
          ...
          function t(e) {
            ...
            switch (e.type) {
              case 'divider':
                ...
                break;
              case 'option':
                (t = K.li(K.a(K.text.call(s, e), e.optionClass, e.inlineStyle), '', e.optID))
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
            var t = document.createElement('div'),
              ...
              d =
                this.options.header && 0 < this.$menu.find('.' + V.POPOVERHEADER).length
        ...
        setSelected: function (e, t) {
          ...
          (o.selected = t),
            ...
            l ||
              ...
              ((i = this.selectpicker.main.elements[this.prevActiveIndex]), this.defocusItem(i));
        },
        ...
        checkDisabled: function () {
          this.isDisabled()
            ? (this.$newElement[0].classList.add(V.DISABLED),
              this.$button.addClass(V.DISABLED).attr('tabindex', -1).attr('aria-disabled', !0))
        ...
        clickListener: function () {
          ...
          t.data('spaceSelect', !1),
            ...
            this.$newElement.on('show.bs.dropdown', function () {
              3 < R.major &&
                !C.dropdown &&
                ((C.dropdown = C.$button.data('bs.dropdown')), (C.dropdown._menu = C.$menu[0]));
            }),
            this.$button.on('click.bs.dropdown.data-api', function () {
            ...
            this.$menuInner.on('click', 'li a', function (e, t) {
              var i = z(this),
                ...
                d = !0;
              if (
                (C.multiple && 1 !== C.options.maxOptions && e.stopPropagation(),
                e.preventDefault(),
                ...
                if (
                  ...
                  if (
                    ...
                    if ((v && b) || (g && w))
                      if (v && 1 == v)
                        (s.selectedIndex = -1), (h.selected = !0), C.setOptionStatus(!0);
                      else if (g && 1 == g) {
                ...
                !C.multiple || (C.multiple && 1 === C.options.maxOptions)
                  ...
                  d &&
                    ((!C.multiple && a === s.selectedIndex) ||
                      ((A = [h.index, p.prop('selected'), l]), C.$element.triggerNative('change')));
              }
            }),
            this.$menu.on(
              'click',
            ...
            this.$searchbox.on('input propertychange', function () {
              ...
              if (((u.selectpicker.search.elements = []), (u.selectpicker.search.data = []), e)) {
                ...
                for (var c = n.length; l < c; l++) {
                  ...
                  ('divider' !== a.type ||
                    ('divider' === a.type && p && 'divider' !== p.type && c - 1 !== l)) &&
              ...
              if (
                  ...
                  e.which === B
                    ? (-1 !== t && t--,
                      ...
                      a.selectpicker.view.canHighlight[t + f] ||
                        (-1 ===
                          (t =
                            a.selectpicker.view.canHighlight.slice(0, t + f).lastIndexOf(!0) - f) &&
                          (t = c.length - 1)))
                    : (e.which !== M && !h) ||
                      (++t + f >= a.selectpicker.view.canHighlight.length && (t = 0),
                      a.selectpicker.view.canHighlight[t + f] ||
                        (t =
                          t + 1 + a.selectpicker.view.canHighlight.slice(t + f + 1).indexOf(!0))),
                  e.preventDefault();
                var m = f + t;
                e.which === B
                  ? 0 === f && t === c.length - 1
                ...
                if (b.length) {
                  ...
                  c.removeClass('active').find('a').removeClass('active'),
                    1 === g.length &&
                      (-1 === (x = b.indexOf(a.activeIndex)) || x === b.length - 1 ? (x = 0) : x++),
                    (v = b[x]),
                    (d =
